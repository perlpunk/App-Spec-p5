...
Options:
    ...
    --force -f    reclone (completely replace) an existing subdir.
...
=head3  _complete
    ...
    subrepo  _complete <subcommands> [options]
...
=head3 _complete bash
    ...
    subrepo _complete bash [options]
